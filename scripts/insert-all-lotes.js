...
async function insertAllLotes() {
  console.log('🚀 Iniciando inserção de TODOS OS 18 LOTES (90 instituições)...\n');
  ...
  console.log(`📊 Total processadas: ${totalInserted + totalErrors}/90`);
}
